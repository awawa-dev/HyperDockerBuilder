...
rm -rf * .[!.]* && ls -la
mkdir qtserialport && wget -qO- https://download.qt.io/official_releases/qt/${qt_main}/${qt_version}/submodules/qtserialport-everywhere-opensource-src-${qt_version}.tar.xz | tar -xJ -C qtserialport --strip-components=1
